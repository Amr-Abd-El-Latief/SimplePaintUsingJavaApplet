...
//************************
	...
	public void paint(Graphics g){
		...
		{
			if(shapeVector.elementAt(counter).getShapeType()==0)
			{//line
			...
			}else if(shapeVector.elementAt(counter).getShapeType()==1)
			{//rect
			...
			}else if(shapeVector.elementAt(counter).getShapeType()==2)
			{//Rounded- rect
				width =Math.abs(shapeVector.elementAt(counter).getCurrentX()-shapeVector.elementAt(counter).getStartX());
				height =Math.abs(shapeVector.elementAt(counter).getCurrentY()-shapeVector.elementAt(counter).getStartY());
			...
			}else if(shapeVector.elementAt(counter).getShapeType()==3)
			{//oval
				width =Math.abs(shapeVector.elementAt(counter).getCurrentX()-shapeVector.elementAt(counter).getStartX());
				height =Math.abs(shapeVector.elementAt(counter).getCurrentY()-shapeVector.elementAt(counter).getStartY());
			...
			}else if(shapeVector.elementAt(counter).getShapeType()==4)
			{//free hand
